...
\frametitle{Microwave Radar}
	\begin{itemize}
		\item A porção do spectro eletromagnético considerada uma frequência útil para radares práticos é entre 3 e 100 GHz;
		\item A maioria dos radares convencionais utiliza energia de miroondas e opera nas bandas L, S C ou X;
		...
		\begin{figure}
            \centering
            \copyrightbox[b]{\includegraphics[scale=0.55]{figures/1_MR_frequency_bands.png}}%
