...
\begin{frame}[allowframebreaks, fragile]
  ...
  \begin{itemize}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/2_local_segmentation.png}}%
...
%------------------------------------------------
  ...
  \begin{itemize}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/1_Laser_Range_Finder_Raw_Data.png}}%
        {Fonte: \cite{buniyamin2011simple}}
...
%------------------------------------------------
  ...
  \begin{itemize}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/3_last_model_and_Current_perceptions_superposition.png}}%
        {Fonte: \cite{buniyamin2011simple}}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/4_prediction_model.png}}%
        {Fonte: \cite{buniyamin2011simple}}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/5_heuristic_matchings.png}}%
        {Fonte: \cite{buniyamin2011simple}}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/6_endpoints_updating.png}}%
        {Fonte: \cite{buniyamin2011simple}}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/7_global_approach_instability.png}}%
        {Fonte: \cite{buniyamin2011simple}}
        \caption{Atualização dos Pontos de Extremidade.}
        \label{fig:7}
      \end{figure}
...
%------------------------------------------------
  ...
  \begin{itemize}
      ...
      \begin{figure}
        \centering
        \copyrightbox[b]{\includegraphics[scale=0.35]{figures/8_actual_experiment_of_incremental_environment_modelling.png}}%
        {Fonte: \cite{buniyamin2011simple}}
