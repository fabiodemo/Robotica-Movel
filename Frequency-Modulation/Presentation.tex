...
\frametitle{Introdução}
	\begin{itemize}
		...
		\item Essa técnica envolve a transmissão de uma onda eletromagnética contínua modulada por um sinal triangular periódico que ajusta a frequência da portadora acima e abaixo da frequência média f0, conforme figura abaixo:
        \begin{figure}
            \centering
            \copyrightbox[b]{\includegraphics[scale=0.7]{figures/1_curva_de_frequencia.png}}%
		...
		\item Citação: \cite{everett1995sensors}
	\end{itemize}
\end{frame}
