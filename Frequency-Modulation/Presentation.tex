...
\frametitle{Automotive Collision Avoidance Radar}
	\begin{itemize}
        ...
        \end{itemize}
        \item Se algum desses parâmetros requerirem que o motorista tome uma ação ofensiva/corretiva, um \textit{buzzer} e uma luz são ativadas em um painel "especial" do veículo.
	\end{itemize}
\end{frame}
