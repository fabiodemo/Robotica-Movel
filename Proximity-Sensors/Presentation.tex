...
\frametitle{Inductive Proximity Sensors}
	\begin{itemize}
		...
		\begin{figure}
			\centering
			\copyrightbox[b]{\includegraphics[scale=0.6]{figures/3_diagram_proximity_sensor.png}}%
			{Fonte: \cite{everett1995sensors}}
...
\frametitle{Capacitive Proximity Sensors}
	\begin{itemize}
		...
		\begin{figure}
			\centering
			\copyrightbox[b]{\includegraphics[scale=0.9]{figures/6_The-capaciflector-as-a-respiratory-rate-RR-sensor-A-Photograph-showing-one-printed.png}}%
...
\frametitle{Optical Proximity Sensors}
	\begin{itemize}
		...
		\begin{figure}
			\centering
			\copyrightbox[b]{\includegraphics[scale=0.4]{figures/8_optical_sensor_opposed_mode.png}}%
			{Fonte: \cite{hayward2022capaciflector}}
			\caption{O sensor de presença de microondas, requere uma antena transmissora e outra receptora separadas.}
			\label{fig:7_microwave_presence_sensor}
		\end{figure}
		...
		\begin{figure}
			\centering
			\copyrightbox[b]{\includegraphics[scale=0.4]{figures/9_optical_sensor_retroreflective_mode.png}}%
			{Fonte: \cite{hayward2022capaciflector}}
			\caption{O sensor de presença de microondas, requere uma antena transmissora e outra receptora separadas.}
			\label{fig:7_microwave_presence_sensor}
		\end{figure}
		...
		\begin{figure}
			\centering
			\copyrightbox[b]{\includegraphics[scale=0.4]{figures/10_optical_sensor_convergent_mode.png}}%
			{Fonte: \cite{hayward2022capaciflector}}
			\caption{O sensor de presença de microondas, requere uma antena transmissora e outra receptora separadas.}
			\label{fig:7_microwave_presence_sensor}
		\end{figure}
