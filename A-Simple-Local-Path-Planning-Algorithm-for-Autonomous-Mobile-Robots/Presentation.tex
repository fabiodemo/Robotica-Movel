...
\begin{frame}[allowframebreaks, fragile]
  ...
  \begin{figure}
    \centering
    \copyrightbox[b]{\includegraphics[scale=0.33]{figures/5_Trajectory_generated_using_Distbug,_TangenBug_and_PointBugalgorithm_in_simple_Office_like_Environment.png}}%
    {Fonte: \cite{buniyamin2011simple}}
...
\begin{frame}[allowframebreaks, fragile]
  ...
  \begin{itemize}
    ...
    \item Eficiência em ambientes dinâmicos, utilizando informações em tempo real de sensores de alcance.
    \item Desempenho influenciado pelo número de pontos súbitos detectados.
    \begin{itemize}
      \item menos pontos indicam maior eficiência.
    \end{itemize}
    \item Efetividade dependente da forma dos obstáculos.
    \begin{itemize}
